...
from main.views import add_product_entry_ajax, edit_product_ajax, delete_product_ajax, proxy_image, create_product_flutter, get_all_products, get_my_products
